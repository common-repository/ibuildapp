...
function ibuildapp_admin_menu()
{
    ...
    if (Ibuildapp::hasKeys()) {
        ...
        if (Ibuildapp::hasApps() && Ibuildapp::getApp()->isCreated()) {
            add_submenu_page('ibuildapp', _x('Edit', 'menu', 'ibuildapp'), _x('Edit', 'menu', 'ibuildapp'), 'manage_options', 'ibuildapp-app-management', 'ibuildapp_app_management');
			...
			add_submenu_page('ibuildapp', _x('Promote', 'menu', 'ibuildapp'), _x('Promote', 'menu', 'ibuildapp'), 'manage_options', 'ibuildapp-app-promote', 'ibuildapp_app_promote');
