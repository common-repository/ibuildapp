...
function ibuildapp_app_dashboard()
{
    ibuildapp_app_displayIframe(sprintf(
		...
		'/app.dashboard.php?app=%d&_lightweight=1&_lightweightEndpoint=%s',
...
{
    ibuildapp_app_displayIframe(sprintf(
        '/new.simulator.php?app=%d&_lightweight=1&_lightweightEndpoint=%s',
        Ibuildapp::getApp()->getAppId(),
        rawurlencode(ibuildapp_get_lw_endpoint())
    ));
}
...
function ibuildapp_app_promote()
{
    ibuildapp_app_displayIframe(sprintf(
        '/promote.php?projectid=%d&_lightweight=1&_lightweightEndpoint=%s',
        Ibuildapp::getApp()->getAppId(),
        rawurlencode(ibuildapp_get_lw_endpoint())
    ));
}
